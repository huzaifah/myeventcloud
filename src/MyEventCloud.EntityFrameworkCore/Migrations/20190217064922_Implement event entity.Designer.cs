...
namespace MyEventCloud.Migrations
{
    ...
    [Migration("20190217064922_Implement event entity")]
    partial class Implementevententity
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MyEventCloud.Events.Event", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("MyEventCloud.Events.EventRegistration", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("MyEventCloud.Events.EventRegistration", b =>
                {
                    b.HasOne("MyEventCloud.Events.Event", "Event")
                        .WithMany("Registrations")
                        .HasForeignKey("EventId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("MyEventCloud.Authorization.Users.User", "User")
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
